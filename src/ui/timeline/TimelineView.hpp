...
// loop region markers, beat grid. Supports zoom and scroll (both axes).
class TimelineView : public juce::Component
{
  public:
    ...
    static constexpr int kScrollbarThickness = 10;
  ...
  private:
    ...
    void paintScrollbars(juce::Graphics &g);
    ...
    enum class ScrollbarDrag { None, Vertical, Horizontal };
    ScrollbarDrag scrollbarDrag_{ScrollbarDrag::None};
