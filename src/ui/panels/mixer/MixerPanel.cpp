...
ChannelStrip::ChannelStrip()
{
    ...
    nameLabel_.setColour(juce::Label::textColourId, juce::Colour(ampl::Theme::textPrimary));
    nameLabel_.setFont(ampl::Theme::labelFont());
    ...
    muteButton_.setColour(juce::TextButton::buttonOnColourId, juce::Colour(ampl::Theme::accentRed));
    ...
    soloButton_.setColour(juce::TextButton::buttonOnColourId,
                          juce::Colour(ampl::Theme::accentYellow));
    ...
    removeButton_.setColour(juce::TextButton::buttonColourId,
                            juce::Colour(ampl::Theme::bgElevated));
...
void ChannelStrip::paint(juce::Graphics &g)
{
    ...
    g.fillRoundedRectangle(area.toFloat().reduced(1.0f), ampl::Theme::cornerRadius);

    // Border
    g.setColour(juce::Colour(ampl::Theme::border));
    g.drawRoundedRectangle(area.toFloat().reduced(1.0f), ampl::Theme::cornerRadius, 1.0f);
...
{
    g.fillAll(juce::Colour(ampl::Theme::bgBase));
...
void MixerPanel::setupMasterStrip()
{
    ...
    masterLabel_.setColour(juce::Label::textColourId, juce::Colour(ampl::Theme::accentOrange));
    masterLabel_.setFont(ampl::Theme::headingFont());
    ...
    masterGainSlider_.setColour(juce::Slider::textBoxOutlineColourId,
                                juce::Colours::transparentBlack);
    masterGainSlider_.setColour(juce::Slider::thumbColourId,
                                juce::Colour(ampl::Theme::accentOrange));
    ...
    masterPanSlider_.setColour(juce::Slider::rotarySliderFillColourId,
                               juce::Colour(ampl::Theme::accentOrange));
    masterPanSlider_.onValueChange = [this]
    {
        auto cmd =
            std::make_unique<SetMasterPanCommand>(static_cast<float>(masterPanSlider_.getValue()));
        commandManager_.execute(std::move(cmd), session_);
        if (onSessionChanged)
            onSessionChanged();
    };
