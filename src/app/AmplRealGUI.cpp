...
private:
    ...
    void drawHeader() {
        ...
        mvprintw(0, 0, "🎛️ AMPL DAW - REAL GUI - Logic Pro X Style");
...
int main() {
    std::cout << "🚀 Starting Ampl DAW Real GUI..." << std::endl;

    try {
        ampl::AmplRealGUI daw;
        daw.run();
