...
public:
    ...
    void run() {
        std::cout << "\n🚀 Starting Ampl DAW Working GUI..." << std::endl;
...
private:
    ...
    void drawHeader() {
        std::cout << "╔══════════════════════════════════════════════════════════════════════════════╗" << std::endl;
        std::cout << "║                    🎛️ AMPL DAW - REAL GUI                        ║" << std::endl;
    ...
    void showHelp() {
        ...
        std::cout << "║   A - About Ampl DAW                                          ║" << std::endl;
    ...
    void showAbout() {
        ...
        std::cout << "╠══════════════════════════════════════════════════════════════════════════════╣" << std::endl;
        std::cout << "║ 🎛️ AMPL DAW - AI-First Digital Audio Workstation              ║" << std::endl;
        std::cout << "║                                                                   ║" << std::endl;
...
int main() {
    ...
    std::cout << "\n🎛️ Ampl DAW GUI closed. Thank you!" << std::endl;
    return 0;
}
