...
// Simplified Ampl DAW with Logic Pro X features
namespace ampl {
...
int main() {
    std::cout << "=== AMPL DAW WITH LOGIC PRO X FEATURES ===" << std::endl;
    ...
    ampl::SimpleMixer mixer;
    ampl::LogicFeatures logic;
